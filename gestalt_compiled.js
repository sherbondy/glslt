...
if(!lt.util.load.provided_QMARK_('lt.plugins.gestalt')) {
goog.provide('lt.plugins.gestalt');
...
goog.require('lt.object');
goog.require('lt.util.load');
lt.plugins.gestalt.manglsl_root = "https://cvs.khronos.org/svn/repos/ogles/trunk/sdk/docs/man3/";
lt.plugins.gestalt.manglsl_html_root = [cljs.core.str(lt.plugins.gestalt.manglsl_root),cljs.core.str("html/")].join('');
lt.plugins.gestalt.manglsl_page = (function manglsl_page(token){return [cljs.core.str(lt.plugins.gestalt.manglsl_html_root),cljs.core.str(token),cljs.core.str(".xhtml")].join('');
});
lt.plugins.gestalt.manglsl_page.call(null,"asin");
lt.plugins.gestalt.symbol_token_QMARK_ = (function symbol_token_QMARK_(s){return cljs.core.re_seq.call(null,/[\w\$_\-\.\*\+\\/\?\><!]/,s);
});
lt.plugins.gestalt.find_symbol_at_cursor = (function find_symbol_at_cursor(editor){var loc = lt.objs.editor.__GT_cursor.call(null,editor);var token_left = lt.objs.editor.__GT_token.call(null,editor,loc);var token_right = lt.objs.editor.__GT_token.call(null,editor,cljs.core.update_in.call(null,loc,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ch","ch",1013907415)], null),cljs.core.inc));var or__6364__auto__ = (cljs.core.truth_(lt.plugins.gestalt.symbol_token_QMARK_.call(null,new cljs.core.Keyword(null,"string","string",4416885635).cljs$core$IFn$_invoke$arity$1(token_right)))?cljs.core.assoc.call(null,token_right,new cljs.core.Keyword(null,"loc","loc",1014011570),loc):null);if(cljs.core.truth_(or__6364__auto__))
{return or__6364__auto__;
} else
{if(cljs.core.truth_(lt.plugins.gestalt.symbol_token_QMARK_.call(null,new cljs.core.Keyword(null,"string","string",4416885635).cljs$core$IFn$_invoke$arity$1(token_left))))
...
lt.plugins.gestalt.manglsl_browser_doc = (function manglsl_browser_doc(editor){var loc = lt.objs.editor.__GT_cursor.call(null,editor);var token = new cljs.core.Keyword(null,"string","string",4416885635).cljs$core$IFn$_invoke$arity$1(lt.plugins.gestalt.find_symbol_at_cursor.call(null,editor));if((token == null))
...
{return lt.object.raise.call(null,editor,new cljs.core.Keyword(null,"editor.doc.show!","editor.doc.show!",1417900223),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1017277949),token,new cljs.core.Keyword(null,"ns","ns",1013907767),"GLSL 1.00",new cljs.core.Keyword(null,"doc","doc",1014003882),lt.plugins.gestalt.manglsl_page.call(null,token),new cljs.core.Keyword(null,"loc","loc",1014011570),loc], null));
}
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.gestalt","manglsl-browser-doc","lt.plugins.gestalt/manglsl-browser-doc",4528451347),new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"editor.doc","editor.doc",3751347369),null], null), null),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.gestalt.manglsl_browser_doc);
lt.plugins.gestalt.glsl_doc_exec = (function glsl_doc_exec(query){lt.objs.notifos.working.call(null,[cljs.core.str("Grabbing doc: "),cljs.core.str(query)].join(''));
...
lt.plugins.gestalt.glsl_doc_search = (function glsl_doc_search(this$,cur){return cljs.core.conj.call(null,cur,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"label","label",1116631654),"glsl",new cljs.core.Keyword(null,"trigger","trigger",4248979754),lt.plugins.gestalt.glsl_doc_exec,new cljs.core.Keyword(null,"file-types","file-types",1727875162),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["Fragment Shader",null,"Vertex Shader",null], null), null)], null));
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.gestalt","glsl-doc-search","lt.plugins.gestalt/glsl-doc-search",1687787877),new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"types+","types+",4450069060),null], null), null),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.gestalt.glsl_doc_search);
}
