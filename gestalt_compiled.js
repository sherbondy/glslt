...
lt.plugins.gestalt.core.manglsl_browser_doc = (function manglsl_browser_doc(editor){var loc = lt.objs.editor.__GT_cursor.call(null,editor);var token = new cljs.core.Keyword(null,"string","string",4416885635).cljs$core$IFn$_invoke$arity$1(lt.plugins.gestalt.core.find_symbol_at_cursor.call(null,editor));if((token == null))
...
{return lt.object.raise.call(null,editor,new cljs.core.Keyword(null,"editor.doc.show!","editor.doc.show!",1417900223),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1017277949),token,new cljs.core.Keyword(null,"ns","ns",1013907767),"GLSL 1.00",new cljs.core.Keyword(null,"doc","doc",1014003882),"this is where the docs would go",new cljs.core.Keyword(null,"loc","loc",1014011570),loc], null));
}
});
